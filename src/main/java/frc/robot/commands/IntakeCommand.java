...
public class IntakeCommand extends CommandBase {
  ...
  @Override
  public void execute() {
    // if(Constants.dXboxController.getLeftTriggerAxis() > 0.10) intake.intake();
    // if(Constants.dXboxController.getRightTriggerAxis() > 0.10) intake.place();
    // if(Constants.dXboxController.getLeftTriggerAxis() < 0.10 && Constants.dXboxController.getRightTriggerAxis() < 0.10) intake.intakeIdle();
