...
public class Auto {
    ...
    private final SortedMap<String, AutoConfig> quickpicks = new TreeMap<>(Map.ofEntries(
        ...
        Map.entry("[Clear-Y] 3 piece best -- 2M1H [outer]", new AutoConfig("SS-PlaceCone,pick,place,pick,place", false, Position.GRID_MID, Position.GRID_HIGH, Position.GRID_MID)),
        Map.entry("[Clear-Y] 2.5 w/2 high [outer]", new AutoConfig("SS-PlaceCone,pick,place,pick,place", false, Position.GRID_HIGH, Position.GRID_HIGH, Position.GRID_MID)),
