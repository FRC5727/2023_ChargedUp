...
public class Auto {
    ...
    private final SortedMap<String, AutoConfig> quickpicks = new TreeMap<>(Map.ofEntries(
        ...
        Map.entry("[No bump] 3 piece column", new AutoConfig("SS-Place,pick,place,pick,place", false, Position.NONE, Position.GRID_HIGH, Position.GRID_MID)),
        ...
        Map.entry("[Speed bump] 2.5 high [outer]", new AutoConfig("SB-PlaceCone,pick,place,pick", false, Position.GRID_HIGH, Position.GRID_HIGH, Position.NONE)),
